...
export async function generateProformaPDFUSD(proforma: Proforma) {
        ...
        },
        {
          ...
          table: {
            ...
            body: [
              ...
              [
                { text: "$", alignment: "right", fontSize: 13 },
                {
                  text: Number(proforma.total).toFixed(2),
                  alignment: "right",
                  fontSize: 13,
                },
              ],
